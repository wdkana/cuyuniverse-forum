...
const DarkToggle = () => {
  ...
  return (
    <div className="relative">
      ...
      <div className="p-1.5 rounded-md focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 bg-slate-700 dark:bg-slate-200 shadow-md shadow-slate-400 dark:shadow-slate-900">
        <svg
