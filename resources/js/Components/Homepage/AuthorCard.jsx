    ...
    >
      <div className={`avatar ${is_online ? "online" : "offline"}`}>
        <div className="w-16 rounded-full ring ring-primary ring-offset-base-100 ring-offset-2">
          <img src={author_image !== null ? `/storage/images/${author_image}` : "/storage/images/defaultavatar.png"} />
        </div>
      </div>
      <div className="stat">
        ...
        <div className="flex justify-between items-end">
          <div className="text-sm">{total_post == 0 ? "belum pernah posting" : `memiliki ${total_post} postingan`}</div>
