    ...
    <div className="mx-auto max-w-7xl overflow-auto px-4 sm:px-6 lg:px-8 ">
      <div className="flex flex-col items-center justify-center gap-4 p-4">
        ...
        <div className="w-full lg:w-1/2">
          ...
          <input className="p-4  border border-spacing-1 block w-full text-sm text-slate-500
      file:mr-4 file:py-2 file:px-4
      file:rounded-full file:border-0
      file:text-sm file:font-semibold
      file:bg-violet-50 file:text-violet-700
      hover:file:bg-violet-100" type="file" name="image" accept="image/*" onChange={(e) => handleImagePost(e.target.files[0])} />
        </div>
        <i>{textTagged[0]}</i>
