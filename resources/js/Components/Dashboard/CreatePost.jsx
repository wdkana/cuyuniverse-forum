      ...
      <div className="flex flex-col justify-center items-center p-4 gap-4">
        ...
        <div className="w-full lg:w-1/2">
          <textarea
            ...
            onChange={description => handleChangePostDescription(description)}></textarea>
        </div>
        <button
          disabled={!isValid}
          className={
            !isValid
              ? "bg-secondary text-secondary-content py-2 rounded-md lg:w-1/2 w-full dark:bg-slate-500 dark:text-slate-200 cursor-not-allowed"
              : "bg-primary text-primary-content py-2 rounded-md hover:bg-blue-600 duration-300 transition-all lg:w-1/2 w-full dark:bg-slate-700 dark:hover:bg-slate-600 cursor-pointer"
          }
