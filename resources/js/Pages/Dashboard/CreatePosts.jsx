...
export default function CreatePosts(props) {
    ...
    const formValidateNotif = () => {
        return (
            <div className="alert alert-sm rounded-md shadow-lg w-full lg:w-1/2 bg-yellow-400">
                <div>
                    <svg
            ...
            <div className="flex flex-col justify-center items-center p-4 gap-4">
                ...
                <div className="w-full lg:w-1/2">
                    <textarea
                        ...
                        maxLength={200}
                        required
                        className="textarea h-36 bg-gray-200 rounded-md w-full"
                ...
                <button
                    disabled={!isValid}
                    className="btn bg-indigo-500 text-white rounded-md lg:w-1/2 w-full"
