...
export default function CreatePosts(props) {
  ...
  const formValidateNotif = () => {
    return (
      <div className="alert alert-sm rounded-md shadow-lg w-full lg:w-1/2 alert-info text-white">
        <div>
          <svg
    ...
    >
      ...
      hover:file:bg-violet-100" /> */}
          ...
          <textarea
            ...
            maxLength={200}
            required
            className="textarea h-36 bg-base-200 rounded-md w-full mt-3"
        ...
        <button
          disabled={!isValid}
          className="btn bg-sky-600 hover:bg-sky-700 text-white rounded-md lg:w-1/2 w-full"
