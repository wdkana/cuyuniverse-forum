  ...
  return (
    <Guest auth={props.auth.user}>
      ...
      <div className='min-h-screen'>
        <div className="text-center pt-6" data-aos="fade-right" data-aos-duration="2500">
        ...
        <div className='flex flex-col justify-center items-center lg:flex-row lg:flex-wrap lg:items-stretch p-4 gap-6' data-aos="fade-up" data-aos-duration="1500">
