...
export const randomColor = (param) => {
  ...
  if (param == "top") {
    option = ['NoHair', 'Hijab', 'Hat', 'Turban', 'WinterHat2', 'LongHairBun', 'LongHairFroBand', 'LongHairShavedSides', 'LongHairDreads', 'ShortHairShaggyMullet', 'ShortHairShortRound', 'ShortHairTheCaesar']
  }
  if (param == "eyes") {
  ...
  if (param == "shirt") {
    option = ['BlazerShirt', 'BlazerSweater', 'CollarSweater', 'GraphicShirt', 'Hoodie', 'ShirtCrewNeck', 'ShirtVNeck']
  }
