                                ...
                                <Dropdown>
                                    <Dropdown.Trigger>
                                        <span className="inline-flex">
                                            <button
                                                type="button"
                                                className="inline-flex items-center py-2 border border-transparent text-sm leading-4 font-medium text-base-500 hover:text-black focus:outline-none transition ease-in-out duration-150"
                                            >
                                                <div className="avatar w-10 h-10 mr-2">
                                                    <img
                                                        ...
                                                        className=" rounded-full ring ring-indigo-300 ring-offset-base-100 ring-offset-2"
                                                    />
                                                </div>
                                                {auth.user.username}
