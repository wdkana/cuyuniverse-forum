<!doctype html>
  <title>CUYUNIVERSE MAINTENANCE</title>
<style>
...
<article>
   <div>
        <svg width="100%" height="100%" viewBox="0 0 1123 837" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect width="720" height="480" fill="black"/>
            <g id="sky" filter="url(#filter0_d)">
            <rect id="background" x="30" y="26" width="720" height="480" rx="20" fill="black"/>
            <g id="stars">
    ...
    <div class="text">
        <h1>Cuy Universe Mandi Dulu Ya! ✌</h1>  
      <h2>Mainentance Development Process</h2>
      <h6>Mohon maaf saat ini website sedang dalam <i>maintenance</i> guna memperbaiki performa untuk kepuasan Cuy People. Kalau kamu pengen bertanya sesuatu <a href="mailto:deacode@icloud.com">hubungi admin sekarang</a>, terimakasih CuyUniverse akan kembali online dari beberapa waktu kedepan!</p></h6> 
      </div>
</article>